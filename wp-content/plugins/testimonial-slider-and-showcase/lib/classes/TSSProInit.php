...
if (!class_exists('TSSProInit')):
    ...
    class TSSProInit {
        ...
        { 
            ...
            $scripts['tss-slick'] = array(
                'src'    => TSSPro()->assetsUrl . 'vendor/slick/slick.min.js',
                'deps'   => array('jquery'),
                'footer' => false
            );
            ...
            $styles['tss-slick-theme'] = TSSPro()->assetsUrl . 'vendor/slick/slick.css';
            $styles['tss-slick'] = TSSPro()->assetsUrl . 'vendor/slick/slick-theme.css';
        ...
        { 
            add_submenu_page('edit.php?post_type=' . TSSPro()->post_type,
                ...
                esc_html__('Settings', 'testimonial-slider-showcase'), 'administrator', 'tss_settings',
