...
if (!class_exists('TSSProHelper')) :
    class TSSProHelper
    {
        ...
        function layoutStyle($layoutID, $meta, $scId = null) {
            ...
            if ($colorSchema) {
                if (!empty($colorSchema['primary'])) {
                    $css .= "#{$layoutID}.tss-wrapper .tss-carousel1,
							#{$layoutID}.tss-wrapper .tss-isotope1 .profile-img-wrapper:after, .tss-wrapper .tss-layout9 .profile-img-wrapper:after, .tss-wrapper .tss-isotope4 .profile-img-wrapper:after, .tss-wrapper .tss-carousel9 .profile-img-wrapper:after { 
            ...
            if ($button) {
                if (!empty($button['bg'])) {
                    $css .= "#{$layoutID}.tss-wrapper .slick-dots li button:before,
						#{$layoutID}.tss-wrapper .tss-utility button,
						#{$layoutID}.tss-wrapper span.rt-slick-nav,
                ...
                if (!empty($button['hover_bg'])) {
                    $css .= "#{$layoutID}.tss-wrapper span.rt-slick-nav:hover,
							#{$layoutID}.tss-wrapper .slick-dots li button:hover:before,
                ...
                if (!empty($button['active_bg'])) {
                    $css .= "#{$layoutID}.tss-wrapper .slick-dots li.slick-active button:before,
