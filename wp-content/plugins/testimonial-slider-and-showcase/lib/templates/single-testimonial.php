...
while ( have_posts() ) : the_post();
    ...
    <div id="content" class="rt-container rt-testimonial-detail-wrapper">
        <div class="rt-row">
            <article id="post-<?php the_ID(); ?>" <?php post_class( 'rt-single-testimonial-detail' ); ?>>
                <div class="rt-col-md-4 rt-col-sm-12 rt-col-xs-12 ">
                    <div class="testi-meta">
                        <div class="profile-img"><?php the_post_thumbnail( 'thumbnail' ); ?></div>
                        <h2><?php the_title(); ?></h2>
						<?php
						$html = '';
						if ( isset( $settings['field'] ) && ! empty( $settings['field'] ) && in_array( 'rating', $settings['field'] ) ) {
                ...
                <div class="rt-col-md-8 rt-col-sm-12 rt-col-xs-12">
					...
					if ( in_array( 'social_media', $settings['field'] ) && ! empty( $social_media ) ) : ?>
					...
					<?php endif; ?>
					<?php if ( isset( $settings['field'] ) && ! empty( $settings['field'] ) && in_array( 'social_share', $settings['field'] ) ) {
